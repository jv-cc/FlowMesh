...
public interface HubControllerSwagger {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "허브 수정 성공", content = @Content(schema = @Schema(implementation = ResDTO.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "허브 삭제 성공", content = @Content(schema = @Schema(implementation = ResDTO.class))),
